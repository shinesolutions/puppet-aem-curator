...
## [Unreleased]
### Added
- Apache hard restart option for deploying Dispatcher Artifacts [#238]

### Changed
- Remove '-k' parameter for Apache restart command [#239]
...
[Unreleased]: https://github.com/shinesolutions/puppet-aem-curator/compare/3.20.0...HEAD
