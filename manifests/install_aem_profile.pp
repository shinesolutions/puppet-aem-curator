...
define aem_curator::install_aem_profile (
  ...
  } elsif $aem_profile == 'aem62_sp1_cfp2' {

    aem_curator::install_aem62_sp1_cfp2 { "${aem_id}: Install AEM profile ${aem_profile}":
      aem_artifacts_base      => $aem_artifacts_base,
      aem_base                => $aem_base,
      aem_healthcheck_version => $aem_healthcheck_version,
      aem_id                  => $aem_id,
  ...
  } elsif $aem_profile == 'aem62_sp1_cfp15' {

    aem_curator::install_aem62_sp1_cfp15 { "${aem_id}: Install AEM profile ${aem_profile}":
      aem_artifacts_base      => $aem_artifacts_base,
      aem_base                => $aem_base,
      aem_healthcheck_version => $aem_healthcheck_version,
      aem_id                  => $aem_id,
  ...
  } elsif $aem_profile == 'aem63_sp1_cfp2' {

    aem_curator::install_aem63_sp1_cfp2 { "${aem_id}: Install AEM profile ${aem_profile}":
      aem_artifacts_base      => $aem_artifacts_base,
      aem_base                => $aem_base,
      aem_healthcheck_version => $aem_healthcheck_version,
      aem_id                  => $aem_id,
  ...
  } elsif $aem_profile == 'aem63_sp2_cfp2' {

    aem_curator::install_aem63_sp2_cfp2 { "${aem_id}: Install AEM profile ${aem_profile}":
      aem_artifacts_base      => $aem_artifacts_base,
      aem_base                => $aem_base,
      aem_healthcheck_version => $aem_healthcheck_version,
      aem_id                  => $aem_id,
  ...
  } elsif $aem_profile == 'aem64_sp1' {

    aem_curator::install_aem64_sp1 { "${aem_id}: Install AEM profile ${aem_profile}":
      aem_artifacts_base      => $aem_artifacts_base,
      aem_base                => $aem_base,
      aem_healthcheck_version => $aem_healthcheck_version,
      aem_id                  => $aem_id,
